/**
 * Indian states and districts for dropdowns. Source: states-and-districts (sab99r/Indian-States-And-Districts).
 * Use with "Other" option and custom text input when user selects Other.
 */
...
export const STATE_DISTRICTS: Record<string, string[]> = {
  ...
  "Lakshadweep (UT)": ["Agatti", "Amini", "Androth", "Kavaratti", "Kalpeni", "Minicoy"],
  ...
  "Punjab": ["Amritsar", "Barnala", "Bathinda", "Faridkot", "Fatehgarh Sahib", "Fazilka", "Ferozepur", "Gurdaspur", "Hoshiarpur", "Jalandhar", "Kapurthala", "Ludhiana", "Mansa", "Moga", "Muktsar", "Pathankot", "Patiala", "Rupnagar", "Sahibzada Ajit Singh Nagar (Mohali)", "Sangrur", "Tarn Taran"],
